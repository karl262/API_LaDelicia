...
export class Product {
  ...
  static async findById(id) {
    const result = await pool.query(
      "SELECT * FROM products WHERE id = $1 AND delete_at IS NULL",
      [id]
    );
  ...
  static async findByName(name_product) {
    const result = await pool.query(
      "SELECT * FROM products WHERE name_product ILIKE $1 AND delete_at IS NULL",
      [`%${name_product}%`]
    );
    return result.rows;
  }
  ...
  static async findByPrice(price_product) {
    const result = await pool.query(
      "SELECT * FROM products WHERE price_product = $1 AND delete_at IS NULL",
      [price_product]
    );
    return result.rows;
  }
  ...
  static async findByStock(stock) {
    const result = await pool.query(
      "SELECT * FROM products WHERE stock = $1 AND delete_at IS NULL",
      [stock]
    );
    return result.rows;
  }
  ...
  static async findBySku(sku) {
    const result = await pool.query(
      "SELECT * FROM products WHERE sku ILIKE $1 AND delete_at IS NULL",
      [`%${sku}%`]
    );
    return result.rows;
  }
